...
function getResponse(txt){
  ...
  fetch("https://calm-forest-14149.herokuapp.com/web", requestOptions)
    ...
    .then(result => {
      ...
      let data = result.message.answer.replace("Agrivoice:","")
